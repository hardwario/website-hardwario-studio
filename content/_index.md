...
contact_cta = "Kontaktovat"

# ---- Závěrečné CTA ----
cta_title = "Připraveni začít?"
cta_text = "Kontaktujte náš tým a probereme požadavky vašeho projektu."
cta_primary = "Domluvit schůzku"
...
desc = "Tam, kde ostatní končí, my začínáme. Díky velkoformátové tiskárně zvládneme tisknout objekty o velikosti až 800 × 800 × 1000 mm, a to v jednom kuse. Bez lepení. Bez kompromisů. Jen maximální pevnost a precizní vzhled."
list = [
...
[[extra.service]]
title = "Profesionální UV potisk s vaším designem"
...
desc = "Nabízíme profesionální 3D tisk s vysokou přesností a kvalitou. Ať už máte hotový model, nebo jen nápad, pomůžeme vám ho přenést do reality. Zvládneme i návrh a tvorbu 3D modelu od základu. Tiskneme z různých materiálů a nabízíme i vícebarevný tisk."
list = [
...
desc = "Chcete vědět, jak vaše zařízení obstojí v extrémních podmínkách? Dokážeme simulovat různé teploty i vlhkostní zatížení a sledovat, jak vaše produkty reagují na náročné prostředí. Tyto testy pomáhají odhalit limity, zvýšit spolehlivost a zabránit selhání v reálném provozu."
list = [
